            ...
            for i, row in enumerate(rows[1:]):
                ...
                if (driver_name.strip() != ""
                    ...
                    if driver_phone:
                        ...
                        driver_msg = (
                            f"🚨 *أمر شغل ليموزين - 24SEVEN LIMOUSINE* 🚕\n"
                            f"(عميل تابع لشركة 24Seven Limousine)\n"
                            f"━━━━━━━━━━━━━━━━━━━━━━━━\n"
                            f"👤 *العميل:* {cust_name}\n"
                            f"📅 *التاريخ:* {str(raw_date)}\n"
                            f"⏰ *الوقت:* {str(trip_time)}\n"
                            f"━━━━━━━━━━━━━━━━━━━━━━━━\n"
                            f"📍 *لوكيشن التحرك:* {pickup}\n"
                            f"🏁 *الوصول:* {dropoff}\n"
                            f"━━━━━━━━━━━━━━━━━━━━━━━━\n"
                            f"💵 *التحصيل من العميل:* {price}\n"
                            f"📝 *ملاحظات:* {notes_content}\n"
                            f"━━━━━━━━━━━━━━━━━━━━━━━━\n"
                            f"💳 *في حالة طلب العميل التحويل:*\n"
                            f"يبلغه بالتحويل على رقم الشركة الثابت (انستاباي / محفظة كاش):\n"
                            f"📲 *01121748885*\n"
                            f"━━━━━━━━━━━━━━━━━━━━━━━━\n"
                            f"📲 *رابط دخول الكابتن لبدء الرحلة والشات:*\n"
                            f"https://24seven-ai.com/driver.html\n"
                            f"🔑 *طريقة الدخول:* برقم تليفونك المسجل فقط (لا توجد كلمة سر)\n"
                            f"━━━━━━━━━━━━━━━━━━━━━━━━\n"
                            f"⚠️ *تعليمات هامة للكابتن:*\n"
                            f"✨ نظافة السيارة التامة داخلياً وخارجياً قبل التوجه للعميل.\n"
                            f"⏰ التواجد قبل موعد الرحلة بوقت كافٍ عند العميل.\n"
                            f"🔄 في حالة أي تغيير في بيانات الرحلة أو خط السير من طرف العميل يجب الرجوع للتشغيل أولاً قبل التنفيذ.\n"
                            f"━━━━━━━━━━━━━━━━━━━━━━━━\n"
                            f"☎️ *للتواصل مع التشغيل والطوارئ:*\n"
                            f"📞 01228482873\n"
                            f"📞 01226408587"
                        )
